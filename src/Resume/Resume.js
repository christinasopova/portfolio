      ...
      <section className="experience">
        <div className="experience-item">
          ...
          <div className="role-description">
            ...
            <p className="description">
              ...
              long training program dedicated to prepare students to think like
              engineers and approach problems creatively in order to build the
              next generation of web applications and digital products.
            </p>
          </div>
        </div>
        ...
        <div className="experience-item">
          ...
          <div className="role-description">
            ...
            <p className="description">
              ...
              chocolate bars. Responsible for developing the marketing strategy,
              allocating assignments to team members, and managing the
              interactions with designers, chocolate producers, and web
              developers. As a result of the successful product execution, the
              limited release Heirloom Chocolate Series sold out in record time.
            </p>
          </div>
        </div>
        ...
        <div className="experience-item">
          ...
          <div className="role-description">
            ...
            <p className="description">
              Assisted the CEO in execution of the management plan for assigned
              projects, including publishing chocolate bar reviews, preparing
              the monthly newsletter, and coming up with a subscription policy
              and addition of new products in the online chocolate store. Used
              Asana and Slack for managing tasks and helped coordinate projects
              from inception to completion. Coordinated and executed daily
        ...
        <div className="experience-item">
          ...
          <div className="role-description">
            ...
            <p className="description">
              Manager digital projects for Ubrir bank, UGMK Clinic, Yarmarka TD
              (high-quality grains and grains mix manufacturer) and Pegas
              Touristik (tour operator): web and mobile applications development
              and marketing strategy. Responsible for developing project plans,
              strategies, detailed timelines with dependencies and milestones,
              estimated projects’ resources, develop WBS, allocating assignments
              to team members, monitor, and control project performance, project
              changes and optimization and status reports for marketing managers
              and CIOs. Managed a team of 10 people. The team included
              developers, system analysts, designers and content managers,
              social media managers, media buyers.
            </p>
          </div>
        </div>
        <div className="experience-item">
          ...
          <div className="role-description">
            ...
            <p className="description">
              ...
              decision makers. Planed, created and updated project schedules and
              timeline as well as prepared budget and execution reports. Set up
              PM/Account Director Dashboards for clients.
            </p>
          </div>
        </div>
      </section>
